...
{labels_html}
        ...
        if risk_score >= 60:
            if st.button("🚨 전화 끊고 신고하기", type="primary", use_container_width=True, key="report_call_btn"):
...
if st.session_state.page == "main":
    ...
    /* 신고 버튼만 위험 빨강으로 (key=report_call_btn) */
    .st-key-report_call_btn div[data-testid="stButton"] > button[kind="primary"] {
        background-color: #E03131 !important;
        border-color: #E03131 !important;
        color: #FFFFFF !important;
    }
    .st-key-report_call_btn div[data-testid="stButton"] > button[kind="primary"]:hover {
